  ...
  return (
    <div className="rounded-lg bg-gray-50 p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <label className="text-sm">Notify me about trending skills & new posts</label>
          <Switch checked={trendingNotifications} onCheckedChange={setTrendingNotifications} />
        </div>

        <Button className="bg-[#6c5ce7] hover:bg-[#5b4fc7]">Save Preference</Button>
      </div>
    </div>
  )
}
